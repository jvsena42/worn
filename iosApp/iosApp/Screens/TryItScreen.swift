...
struct TryItScreen: View {
    ...
    var body: some View {
        ...
        .accessibilityIdentifier(WornTestTags.tryItScreen)
    ...
    private var aiEmptyContent: some View {
        VStack(spacing: 24) {
            ...
            .accessibilityIdentifier(WornTestTags.tryItConnectCta)
    ...
    private func uploadZone(height: CGFloat) -> some View {
        ...
        .buttonStyle(.plain)
        .accessibilityIdentifier(WornTestTags.tryItUploadZone)
    }
    ...
    private var analyzeButton: some View {
        ...
        .accessibilityIdentifier(WornTestTags.tryItAnalyzeButton)
    }
