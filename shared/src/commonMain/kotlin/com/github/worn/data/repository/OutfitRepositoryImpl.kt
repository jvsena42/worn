...
class OutfitRepositoryImpl(
    ...
    override suspend fun getAll(): List<Outfit> = withContext(dispatcher) {
    ...
    override suspend fun getById(id: String): Outfit? = withContext(dispatcher) {
        val dbOutfit = db.outfitQueries.getById(id).executeAsOneOrNull() ?: return@withContext null
        val itemIds = db.outfitItemQueries
            .getItemIdsForOutfit(dbOutfit.id)
            .executeAsList()
        Outfit(
    ...
    override suspend fun createOutfit(name: String, itemIds: List<String>): Outfit =
    ...
    override suspend fun updateOutfit(outfit: Outfit): Outfit = withContext(dispatcher) {
        db.transaction {
    ...
    override suspend fun deleteOutfit(id: String): Unit = withContext(dispatcher) {
