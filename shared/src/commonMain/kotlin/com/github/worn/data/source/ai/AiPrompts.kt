...
private const val SUBCATEGORY_VALUES = "T_SHIRT, POLO, DRESS_SHIRT, LONG_SLEEVE_SHIRT, HENLEY, " +
    "JEANS, CHINOS, TAILORED_PANTS, SHORTS, CARGO_PANTS, SWEATPANTS, SWEATER, HOODIE, BOMBER, " +
    "TRUCKER, PUFFER, BLAZER, COAT, WINDBREAKER, SNEAKERS, BOOTS_MILITARY, BOOTS_CHELSEA, DERBY, " +
    "OXFORD, LOAFER, SANDALS, WATCH, BELT, SUNGLASSES, HAT_CAP, SCARF, BAG_BACKPACK"
